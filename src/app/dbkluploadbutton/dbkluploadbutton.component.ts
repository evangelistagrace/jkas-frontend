...
@Component({
  selector: 'app-dbkluploadbutton',
  templateUrl: './dbkluploadbutton.component.html',
  styleUrls: ['./dbkluploadbutton.component.css']
})
export class DbkluploadbuttonComponent implements OnInit {
