...
@Component({
  selector: 'app-inventorymap',
  templateUrl: './inventorymap.component.html',
  styleUrls: ['./inventorymap.component.css']
})
export class InventorymapComponent implements OnInit {
  ...
  parliamens = featureLayers // mapLayers // MAP: 3, 5, 6
  ...
  tableSetup (featureLayer: FeatureLayer) {
   ...
   // console.log(featureLayer)
    ...
    const featureTable = new FeatureTable({
      ...
      layer: featureLayer,
      editingEnabled: true, // false MAP: 3, 5, 6
      fieldConfigs: [
        {
          name: "OBJECTID",
          label: "ID",
