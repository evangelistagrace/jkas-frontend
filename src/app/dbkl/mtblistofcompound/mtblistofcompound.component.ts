...
@Component({
  selector: "app-mtblistofcompound",
  templateUrl: "./mtblistofcompound.component.html",
  styleUrls: ["./mtblistofcompound.component.css"],
})
export class MtblistofcompoundComponent implements OnInit {
  ...
  constructor(
    ...
    this.http
      .get(this.basePublicUrl + "/dbkl/getMTBCompoundList", {
        headers: headers,
      })
      .subscribe(
        (res) => {
    ...
    this.http
      ...
      .subscribe(
        (res) => {
          this.spinner.hide();
          this.getDate = res;  
         console.log("hyydate",this.getDate);
         for(let key of this.getDate){
  ...
  redir(id:string){
    ...
    //console.log(this.mtbUser);
   // console.log(this.parlime);
    this.parlime=localStorage.getItem("parlime");
    this.router.navigate(['/dbkl/mtbdailylistofcompound'], { queryParams: { value:  this.datee,value2: this.mtbUser,value3: this.parlime} });
  }
