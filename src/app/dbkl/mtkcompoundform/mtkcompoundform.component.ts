...
@Component({
  selector: 'app-mtkcompoundform',
  templateUrl: './mtkcompoundform.component.html',
  styleUrls: ['./mtkcompoundform.component.css']
})
export class MtkcompoundformComponent implements OnInit {
