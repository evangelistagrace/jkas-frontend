...
@Component({
  selector: 'app-inactive-area',
  templateUrl: './inactive-area.component.html',
  styleUrls: ['./inactive-area.component.css']
})
export class InactiveAreaComponent implements OnInit {
