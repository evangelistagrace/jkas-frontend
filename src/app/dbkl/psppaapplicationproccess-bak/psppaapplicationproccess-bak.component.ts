...
@Component({
  selector: "app-psppaapplicationproccess-bak",
  templateUrl: "./psppaapplicationproccess-bak.component.html",
  styleUrls: ["./psppaapplicationproccess-bak.component.css"],
})
export class PsppaapplicationproccessBakComponent implements OnInit {
