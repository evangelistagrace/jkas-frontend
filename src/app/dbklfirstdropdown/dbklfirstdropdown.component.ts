...
@Component({
  selector: "app-dbklfirstdropdown",
  templateUrl: "./dbklfirstdropdown.component.html",
  styleUrls: ["./dbklfirstdropdown.component.css"],
})
export class DbklfirstdropdownComponent implements OnInit {
  token: string;
