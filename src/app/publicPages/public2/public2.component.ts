...
@Component({
  selector: "app-public",
  templateUrl: "./public2.component.html",
  styleUrls: ["./public2.component.css"],
})

export class Public2Component {
  ...
  ngOnInit(): void {
    ...
    this.http
      .post(this.basePublicUrl + "/public/getAnnouncement/" + this.lang, { headers: headers })
      .subscribe(
        (res) => {
    ...
    this.http
      .post(this.basePublicUrl + "/public/getManual/" + this.lang, { headers: headers })
      .subscribe(
        (res) => {
  ...
  showDiv(index,imgurl) {
    ...
    this.imagelink=environment.basePublicUrl+ '/jkas_resourses/free/images/'+imgurl;
  ...
  announcement() {
    ...
    document.getElementById("announce").className = "active";
  }
  ...
  dbklurl() {
    ...
    window.location.href = this.basePublicUrl + "/jkas_resourses/free/pdfs/PROGRAM1C1R.pdf";
  ...
  manualurl2() {
    window.open(this.SERVER_URL + "/jkas_resourses/free/pdfs/JKASManualPengguna.pdf");
  }
  secondmanual() {
    window.open(this.SERVER_URL + "/jkas_resourses/free/pdfs/ManualPengguna.pdf");
  }
  firstmanual() {
    window.open(this.SERVER_URL + "/jkas_resourses/free/pdfs/CARTAALIRSERAHANKAWASAN.pdf");
  }
}
