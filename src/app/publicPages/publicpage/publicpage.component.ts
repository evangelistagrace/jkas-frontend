...
export class PublicpageComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    localStorage.setItem("path", "publicpage");
  ...
  settings = {
    ...
    columns: {
      ...
      mesyuarat_permohanan_serahan_kawasan: {
        title: "4.MESYUARAT PERMOHANAN SERAHAN KAWASAN",
      },
  ...
  routeToNewApplication1(){
    this.router.navigateByUrl("/public/publicpages");
  ...
  manualvideo(){
    window.open(this.basePublicUrl+"/jkas_resourses/free/videos/Manualvideo.mp4");
  } cancel() {
