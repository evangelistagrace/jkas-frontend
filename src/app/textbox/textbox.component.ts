      ...
      .subscribe(
        ...
        (error) => {
          ...
          if (this.errorMsg == "application_list_not_updated") {
            if (this.lang == 'en') {
              this.errmsg = "Application List could not be updated! Please refer console logs for further details.";
            }
            else {
              this.errmsg = "Senarai Aplikasi tidak dapat dikemas kini! Sila rujuk log konsol untuk keterangan lebih lanjut."
            }
          }
