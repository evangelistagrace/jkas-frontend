...
@Component({
  selector: 'app-collectnshedule',
  templateUrl: './collectnshedule.component.html',
  styleUrls: ['./collectnshedule.component.css']
})
export class CollectnsheduleComponent implements OnInit {
...
*/
  ...
  initMap () {
    ...
    /*
    //TODO: convert to client side feature layer to avoid keep on query when extend change
    const u = 'http://g-aset.dbkl.gov.my/gasset1/rest/services/Data_JPrB_2019a/FeatureServer/5'
 ...
 if (!this.accessToken) {
  ...
  loadLayer () {
    ...
    if (this.selectedfeaturelayer === 2) {
     ...
     // console.error('housing')
     // console.log(this.housingSymbol)
